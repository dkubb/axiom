...
describe 'Veritas::Optimizer::Logic::Predicate::GreaterThanOrEqualTo::AlwaysFalse#optimizable?' do
  ...
  before do
    predicate.should be_kind_of(Veritas::Logic::Predicate::GreaterThanOrEqualTo)
  end
