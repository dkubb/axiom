...
NOTE: Veritas works best with ruby 1.9, however if you are using ruby 1.8 you must also install and require backports and backports/basic_object before, eg:
